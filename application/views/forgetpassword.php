...
<body style="background-image: url(../Tulips.JPG);color: rgb(195, 132, 0);background-size: cover;background-repeat:no-repeat;background-position:center;height:100vh;width:100vw;top:0 !important;bottom:0 !important;">
	<div class="col-md-4 col-md-offset-4">
		<center><h2><br></h2><h2><br></h2></center>
			<!-- ALERT LOGIN -->
             <?php if($this->session->flashdata('alertgagalforget')) : ?>
            <div class="alert alert-danger alert-dismissible" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <?= $this->session->flashdata('alertgagalforget');?>
            </div>
             <?php endif ?>
    ...
    <div class="outter-form-login-luar">
      <div class="outter-form-login-dalam">
		<form action="<?php echo base_url().'help/forgetpassword_act' ?>" class="inner-login" method="post">
            <h3 class="text-center title-login">Forget Password</h3>
            <hr>
            <br>
			...
			<br>
  <input type="submit" class="btn btn-block btn-custom-black" value="Forget Password">
