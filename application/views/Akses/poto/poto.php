...
<a href=" <?php echo base_url().'Dashboard/download_zip/'.$this->uri->segment('3') ?>">
...
<a class="btn btn-primary btn-sm" href="<?php echo base_url().'Dashboard/edit_poto/'.$z->kd_absen; ?>">Edit</a>
<a onclick="return confirm('Apakah anda yakin ingin menghapus Poto ini?');" class="btn btn-warning btn-sm" href="<?php echo base_url().'Dashboard/hapus_poto/'.$z->kd_absen; ?>">Hapus</a>
