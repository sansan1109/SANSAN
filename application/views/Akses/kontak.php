...
<?php endif ?>
  ...
  <a class="btn btn-primary btn-md" href="<?php echo base_url().'Dashboard/tambah_kontak'; ?>" style="margin-bottom: 15px; float: right;">Add Kontak</a>
...
<a style="width: 70px;height: 24px;" href="<?php echo "https://wa.me/".$hp0 ?>"> <img src="<?php echo base_url().'assets/wa.png' ?>"style="width: 30px;" ></a>
        ...
        <td nowrap="nowrap">
       <a class="btn btn-primary btn-xs" style="width: 70px;height: 24px;" href="<?php echo base_url().'Dashboard/edit_kontak/'.$a->no; ?>">Lihat/Edit</a><br/>
        <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');" class="btn btn-danger btn-xs edit-record" style="width: 70px;height: 24px;" href="<?php echo base_url().'Dashboard/hapus_kontak/'.$a->no; ?>">Hapus</a>
